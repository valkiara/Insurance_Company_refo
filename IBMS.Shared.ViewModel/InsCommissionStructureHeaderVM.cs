...
{
    public class InsCommissionStructureHeaderVM
    {
        ...
        public List<ChargeTypeVM> ChargeTypeList { get; set; }

        //public static implicit operator InsCommissionStructureHeaderVM(global::Newtonsoft.Json.Linq.JObject v)
        //{
