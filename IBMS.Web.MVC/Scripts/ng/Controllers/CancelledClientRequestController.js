...
ibmsApp.controller("CancelledClientRequestController", function ($scope, $http, CancelledClientRequestService, $location, AuthService, Excel, $timeout) {
    ...
    $scope.getCancelledRequest = function () {
        try {
            ...
            CancelledClientRequestService.getCancelledRequest(fromDate, toDate, type).then(function (results) {
                $scope.showLoader = false;
