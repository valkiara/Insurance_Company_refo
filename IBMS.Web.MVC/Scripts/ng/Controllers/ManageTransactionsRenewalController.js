...
ibmsApp.controller("ManageTransactionsRenewalController", function ($scope, $http, $rootScope, ManageTransactionsService, $location, AuthService, filterFilter, $modal) {
                    ...
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        if (isEdit) {
                            ...
                            $scopeChild.updateCustomerDetails = function () {
                                ...
                                if ($scope.customerObj.AgentType === undefined || $scope.customerObj.AgentType === "" || $scope.customerObj.AgentType === null)
                                    $scope.cusObj.AgentType = 0;
                                else
                                    $scope.cusObj.AgentType = $scopeChild.customerObj.AgentType;

                                if ($scope.customerObj.TitleID === undefined || $scope.customerObj.TitleID === "" || $scope.customerObj.TitleID === null)
                                    $scope.cusObj.TitleID = 0;
                                else
                                    $scope.cusObj.TitleID = $scopeChild.customerObj.TitleID;

                                if ($scope.customerObj.ClientName === undefined || $scope.customerObj.ClientName === "" || $scope.customerObj.ClientName === null)
                                    $scope.cusObj.ClientName = "";
                                else
                                    $scope.cusObj.ClientName = $scopeChild.customerObj.ClientName;


                                if ($scope.customerObj.ClientOtherName === undefined || $scope.customerObj.ClientOtherName === "" || $scope.customerObj.ClientOtherName === null)
                                    $scope.cusObj.AgentType = 0;
                                else
                                ...
                                if ($scope.customerObj.ClientAddress === undefined || $scope.customerObj.ClientAddress === "" || $scope.customerObj.ClientAddress === null)
                                ...
                                if ($scope.customerObj.ContactNo === undefined || $scope.customerObj.ContactNo === "" || $scope.customerObj.ContactNo === null)
                                    $scope.cusObj.ContactNo = 0;
                                else
                                    $scope.cusObj.ContactNo = $scopeChild.customerObj.ContactNo;

                                if ($scope.customerObj.FixedLine === undefined || $scope.customerObj.FixedLine === "" || $scope.customerObj.FixedLine === null)
                                    $scope.cusObj.FixedLine = 0;
                                else
                                    $scope.cusObj.FixedLine = 0;

                                if ($scope.customerObj.Email === undefined || $scope.customerObj.Email === "" || $scope.customerObj.Email === null)
                                    $scope.cusObj.Email = "";
                                else
                                    $scope.cusObj.Email = $scopeChild.customerObj.Email;

                                if ($scope.customerObj.DOB === undefined || $scope.customerObj.DOB === "" || $scope.customerObj.DOB === null) {
                                ...
                                if ($scope.customerObj.PartnerID === undefined || $scope.customerObj.PartnerID === "" || $scope.customerObj.PartnerID === null)
                                    $scope.cusObj.PartnerID = 0;
                                else
                                    $scope.cusObj.PartnerID = $scope.customerObj.PartnerID;

                                if ($scope.customerObj.JoinDate === undefined || $scope.customerObj.JoinDate === "" || $scope.customerObj.JoinDate === null) {
                                    $scope.cusObj.JoinDate = "";
                                    $scope.cusObj.JoinDate = $scope.getFormattedDate($scopeChild.customerObj.JoinDate);
                                }
                                else
                                    $scope.cusObj.JoinDate = $scope.getFormattedDate($scopeChild.customerObj.JoinDate);
                                if ($scope.customerObj.GroupID === undefined || $scope.customerObj.GroupID === "" || $scope.customerObj.GroupID === null) {
                                ...
                                if ($scope.customerObj.AdditionalNote === undefined || $scope.customerObj.AdditionalNote === "" || $scope.customerObj.AdditionalNote === null)
                                    $scope.cusObj.AdditionalNote = "";
                                else
                                    $scope.cusObj.AdditionalNote = $scope.customerObj.AdditionalNote;

                                if ($scope.customerObj.HomeCountryID === undefined || $scope.customerObj.HomeCountryID === "" || $scope.customerObj.HomeCountryID === null)
                                    $scope.cusObj.HomeCountryID = 0;
                                else
                                    $scope.cusObj.HomeCountryID = $scopeChild.customerObj.HomeCountryID;


                                if ($scope.customerObj.ResidentCountryID === undefined || $scope.customerObj.ResidentCountryID === "" || $scope.customerObj.ResidentCountryID === null)
                            ...
                            $scopeChild.saveCustomerDetails = function () {
                                ...
                                if ($scopeChild.customerObj.JoinDate === undefined || $scopeChild.customerObj.JoinDate === "" || $scopeChild.customerObj.JoinDate === null) {
                                    $scopeChild.customerObj.JoinDate = "";
                                    //$scope.cusObj.JoinDate = $scope.getFormattedDate($scopeChild.customerObj.JoinDate);
                                }
                                else
                                    $scope.cusObj.JoinDate = $scope.getFormattedDate($scopeChild.customerObj.JoinDate);
                                ...
                                controller: [
                                        '$scope', '$modalInstance', '$http', function ($scopeSubChild, $modalInstance, $http) {
                                            ...
                                            $scopeSubChild.addInsCompanyScopeDetails = function () {
                                                $scopeSubChild.quotationDetailsInsCompanyScopeTemp.push({ MemberName: "", MemberDOB: "", NIC: "", Contact: "", MemberCountryID: "" });
                                            };
