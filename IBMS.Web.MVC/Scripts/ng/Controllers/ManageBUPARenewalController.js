            ...
            if (results.status === true) {
                ...
                if ($scope.cusObj.DeductionDetails.length == 0) {
                    ...
                    if ($scope.cusObj.PremiumAccept == '1') {
                        ...
                        $scope.cusObj.DeductionDetails.push({ PremiumHolder: $scope.cusObj.ClientOtherName, MI: $scope.cusObj.MembershipID, Premium: "", LoadingRate: "", DeductionRate: "", NetPremium: "", SNo: "", SeqSubNo:"" });
                    ...
                    for (var i = 0; i < $scope.cusObj.FamilyDetails.length; i++) {
                        ...
                        if ($scope.cusObj.FamilyDetails[i].MemberName != "")
                            $scope.cusObj.DeductionDetails.push({ PremiumHolder: $scope.cusObj.FamilyDetails[i].MemberName, MI: $scope.cusObj.FamilyDetails[i].MembershipID, Premium: "", LoadingRate: "", DeductionRate: "", NetPremium: "", SNo: "", SeqSubNo: "" });
...
parseInt(results.data.PaiedAmount.toString()) == 0) {
    ...
    $scope.viewClientHistoryRequest = function (clientReqHeaderID, clientID) {
        $scope.activateNewClientRequestTab();
