...
ibmsApp.controller("RenewalController", function ($scope, $http,RenewalService ,$location, AuthService, Excel, $timeout) {
    ...
    $scope.getExpiryClientListByDate = function () {
        try {
            ...
            RenewalService.getExpiryClientListByDate(fromDate, toDate, type).then(function (results) {
                $scope.showLoader = false;
