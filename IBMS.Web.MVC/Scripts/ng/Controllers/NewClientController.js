...
ibmsApp.controller("NewClientController", function ($scope, $http, NewClientService, $location, AuthService, Excel, $timeout) {
    ...
    $scope.getNewClient = function () {
        try {
            ...
            NewClientService.getNewClient(fromDate, toDate, type).then(function (results) {
                $scope.showLoader = false;
