...
ibmsApp.controller("ManageTransactionController", function ($scope, $http, $rootScope, ManageTransactionService, $location, AuthService, filterFilter, $modal) {
    ...
    $scope.loadProRateObject = function (clientID, cusReqObj) {
        ...
        $scope.Age = "";
        $scope.ProRateObj = [];
        ManageTransactionService.getClientByID(clientID).then(function (results) {
    ...
    $scope.GetAgeWisePremium = function (age, PremiumID) {
        ...
        ManageTransactionService.GetAgeWisePremium().then(function (results) {
    ...
    $scope.loadClientsByBUID = function (businessUnitID) {
        ...
        ManageTransactionService.getAllClientRequestsByBUID(businessUnitID).then(function (results) {
    ...
    $scope.loadClientsByBUID = function (businessUnitID) {
        //$scope.showLoader = true;
        ManageTransactionService.getAllClientsByBUID(businessUnitID).then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
                                ...
                                buttons: [
                                        {
                                            addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function ($noty) {
                                                ...
                                                ManageTransactionService.sendEmailRequest($scopeChild.emailObj).then(function (results) {
    ...
    $scope.loadAgent = function () {
        //$scope.showLoader = true;
        ManageTransactionService.loadAgent().then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
                for (var i = 0; i < results.data.length; i++) {
    ...
    $scope.loadPartners = function () {
        //$scope.showLoader = true;
        ManageTransactionService.getAllPartners().then(function (results) {
            //$scope.showLoader = false;
    ...
    $scope.loadFamilyDiscount = function () {
        //$scope.showLoader = true;
        ManageTransactionService.loadFamilyDiscount().then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
    ...
    $scope.loadInsSubClassesByBUID = function (buid) {
        //$scope.showLoader = true;
        ManageTransactionService.getAllInsSubClassesByBUID(buid).then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
                for (var i = 0; i < results.data.length; i++) {
            ...
            controller: [
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        $scopeChild.loadTitles = function () {
                            ...
                            ManageTransactionService.loadTitle().then(function (results) {
                        ...
                        $scopeChild.homeCountries = function () {
                            ManageTransactionService.getAllCountries().then(function (results) {
                                if (results.status === true) {
                                    for (var i = 0; i < results.data.length; i++) {
                                ...
                                controller: [
                                        '$scope', '$modalInstance', '$http', function ($scopeSubChild, $modalInstance, $http) {
                                            ...
                                            $scopeSubChild.GetRealationship = function () {
                                                ManageTransactionService.loadRelationship().then(function (results) {
                                                    if (results.status === true) {
                                                        for (var i = 0; i < results.data.length; i++) {
                                            ...
                                            $scopeSubChild.getGenderDetails = function () {
                                                ManageTransactionService.loadGender().then(function (results) {
                                                    if (results.status === true) {
                                                        for (var i = 0; i < results.data.length; i++) {
                                            ...
                                            if (isEdit) {
                                                ...
                                                //else
                                                    ...
                                                    $scopeSubChild.quotationDetailsInsCompanyScopeTemp = angular.copy($scope.cusObjs.FamilyDetails);
            ...
            controller: [
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        $scopeChild.loadBanks = function (BUID) {
                            //$scope.showLoader = true;
                            ManageTransactionService.loadBanks(BUID).then(function (results) {
                                //$scope.showLoader = false;
                                if (results.status === true) {
                                    for (var i = 0; i < results.data.length; i++) {
                        ...
                        ManageTransactionService.getClientRequestByID(ClientReqID).then(function (results) {
                            $scope.showLoader = false;
                            ...
                            if (results.status === true) {
                                ...
                                ManageTransactionService.getAgentByID($scope.cusReqObj.AgentID).then(function (results) {
                                ...
                                $scopeChild.loadBankByID = function (bankID) {
                                    ManageTransactionService.loadBankByID(bankID).then(function (results) {
                                ...
                                $scopeChild.saveBankDetails = function () {
                                    ...
                                    ManageTransactionService.saveBankTransaction($scopeChild.bankObj).then(function (results) {
                                        if (results.status === true) {
                                            ManageTransactionService.savePayment($scope.cusReqObj, $scope.currentUser.UserID).then(function (results) {
                                                // $scope.showLoader = false;
            ...
            controller: [
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        $scopeChild.loadInsSubClassScopes = function (insSubClassID) {
                            $scopeChild.showLoader = true;
                            ManageTransactionService.getAllInsSubClassScope(insSubClassID).then(function (results) {
                                $scopeChild.showLoader = false;
                                if (results.status === true) {
                                    for (var i = 0; i < results.data.length; i++) {
                        ...
                        addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function ($noty) {
                         ...
                         //   alert('ok');
                          //  $scope.cusReqObj.FamilyDetails = $scope.cusObj.ChildrenDetailss;
                            ...
                            ManageTransactionService.saveClientRequest($scope.isCustomerUpdated, $scope.isCustomerAdded, $scope.cusObj, $scope.cusReqObj, $scope.currentUser.UserID).then(function (results) {
                                $scope.showLoader = false;
                                //alert(angular.toJson(results));
                                if (results.status === true) {
                                    noty({
    ...
    $scope.editClientRequest = function (clientReqHeaderID, clientID) {
        ...
        $scope.cusObj.DeductionDetails = [];
        $scope.showLoader = true;
        ManageTransactionService.getClientRequestByID(clientReqHeaderID).then(function (results) {
            $scope.showLoader = false;
            if (results.status === true) {
                $scope.isViewMode = false;
            ...
            buttons: [
                    {
                        addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function ($noty) {
                            ...
                            ManageTransactionService.updateClientRequest($scope.isCustomerUpdated, $scope.isCustomerAdded, $scope.cusObj, $scope.cusReqObj, $scope.currentUser.UserID).then(function (results) {
                                $scope.showLoader = false;
                                //alert(angular.toJson(results));
                                if (results.status === true) {
                                    noty({
    ...
    $scope.initializeQuotation = function (clientReqHeaderID) {
        ...
        $scope.showLoader = true;
        ManageTransactionService.initializeQuotation($scope.quotationHeader, $scope.currentUser.UserID).then(function (results) {
            $scope.showLoader = false;
            if (results.status === true) {
                $scope.quotationHeader = {};
                noty({
