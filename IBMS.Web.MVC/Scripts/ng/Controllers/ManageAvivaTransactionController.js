...
ibmsApp.controller("ManageAvivaTransactionController", function ($scope, $http, $rootScope, ManageAvivaTransactionService, $location, AuthService, filterFilter, $modal) {
    ...
    $scope.loadProRateObject = function (clientID, cusReqObj) {
        ...
        $scope.Age = "";
        $scope.ProRateObj = [];
        ManageAvivaTransactionService.getClientByID(clientID).then(function (results) {
    ...
    $scope.GetAgeWisePremium = function (age, PremiumID) {
        ...
        ManageAvivaTransactionService.GetAgeWisePremium().then(function (results) {
    ...
    $scope.CalculateProRate = function (join) {
        ...
        //    return $scope.cusReqObj.PolicyStartDate;
        //}
        //else
        //{
        ...
        //    return $scope.cusReqObj.PolicyEndDate;
        //}
        //else {
    ...
    $scope.loadClientsByBUID = function (businessUnitID) {
        ...
        ManageAvivaTransactionService.getAllClientRequestsByBUID(businessUnitID).then(function (results) {
    ...
    $scope.loadClientsByBUID = function (businessUnitID) {
        //$scope.showLoader = true;
        ManageAvivaTransactionService.getAllClientsByBUID(businessUnitID).then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
                                ...
                                buttons: [
                                        {
                                            addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function ($noty) {
                                                ...
                                                ManageAvivaTransactionService.sendEmailRequest($scopeChild.emailObj).then(function (results) {
    ...
    $scope.loadAgent = function () {
        //$scope.showLoader = true;
        ManageAvivaTransactionService.loadAgent().then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
                for (var i = 0; i < results.data.length; i++) {
    ...
    $scope.loadPartners = function () {
        //$scope.showLoader = true;
        ManageAvivaTransactionService.getAllPartners().then(function (results) {
            //$scope.showLoader = false;
    ...
    $scope.loadFamilyDiscount = function () {
        //$scope.showLoader = true;
        ManageAvivaTransactionService.loadFamilyDiscount().then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
    ...
    $scope.loadInsSubClassesByBUID = function (buid) {
        //$scope.showLoader = true;
        ManageAvivaTransactionService.getAllInsSubClassesByBUID(buid).then(function (results) {
            //$scope.showLoader = false;
            if (results.status === true) {
                for (var i = 0; i < results.data.length; i++) {
    ...
    //$scope.deleteItem = function (deleteIndex) saveCustomerRequestsaveCustomerRequest
            ...
            controller: [
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        $scopeChild.loadTitles = function () {
                            ...
                            ManageAvivaTransactionService.loadTitle().then(function (results) {
                        ...
                        $scopeChild.homeCountries = function () {
                            ManageAvivaTransactionService.getAllCountries().then(function (results) {
                                if (results.status === true) {
                                    for (var i = 0; i < results.data.length; i++) {
                                ...
                                controller: [
                                        '$scope', '$modalInstance', '$http', function ($scopeSubChild, $modalInstance, $http) {
                                            ...
                                            $scopeSubChild.GetRealationship = function () {
                                                ManageAvivaTransactionService.loadRelationship().then(function (results) {
                                                    if (results.status === true) {
                                                        for (var i = 0; i < results.data.length; i++) {
                                            ...
                                            $scopeSubChild.getGenderDetails = function () {
                                                ManageAvivaTransactionService.loadGender().then(function (results) {
                                                    if (results.status === true) {
                                                        for (var i = 0; i < results.data.length; i++) {
                                            ...
                                            $scopeSubChild.saveInsCompanyScopeDetails = function () {
                                                ...
                                                alert($scope.cusObj.FamilyDetails.length);
                                                $modalInstance.close();
                                            };
            ...
            controller: [
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        $scopeChild.loadBanks = function (BUID) {
                            //$scope.showLoader = true;
                            ManageAvivaTransactionService.loadBanks(BUID).then(function (results) {
                                //$scope.showLoader = false;
                                if (results.status === true) {
                                    for (var i = 0; i < results.data.length; i++) {
                        ...
                        ManageAvivaTransactionService.getClientRequestByID(ClientReqID).then(function (results) {
                            $scope.showLoader = false;
                            ...
                            if (results.status === true) {
                                ...
                                ManageAvivaTransactionService.getAgentByID($scope.cusReqObj.AgentID).then(function (results) {
                                ...
                                $scopeChild.loadBankByID = function (bankID) {
                                    ManageAvivaTransactionService.loadBankByID(bankID).then(function (results) {
                                ...
                                $scopeChild.saveBankDetails = function () {
                                    ...
                                    ManageAvivaTransactionService.saveBankTransaction($scopeChild.bankObj).then(function (results) {
                                        if (results.status === true) {
                                            ManageAvivaTransactionService.savePayment($scope.cusReqObj, $scope.currentUser.UserID).then(function (results) {
                                                // $scope.showLoader = false;
            ...
            controller: [
                    '$scope', '$modalInstance', '$http', function ($scopeChild, $modalInstance, $http) {
                        ...
                        $scopeChild.loadInsSubClassScopes = function (insSubClassID) {
                            $scopeChild.showLoader = true;
                            ManageAvivaTransactionService.getAllInsSubClassScope(insSubClassID).then(function (results) {
                                $scopeChild.showLoader = false;
                                if (results.status === true) {
                                    for (var i = 0; i < results.data.length; i++) {
                        ...
                        addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function ($noty) {
                         ...
                         //   alert('ok');
                          //  $scope.cusReqObj.FamilyDetails = $scope.cusObj.ChildrenDetailss;
                            ...
                            ManageAvivaTransactionService.saveClientRequest($scope.isCustomerUpdated, $scope.isCustomerAdded, $scope.cusObj, $scope.cusReqObj, $scope.currentUser.UserID).then(function (results) {
                                $scope.showLoader = false;
                                //alert(angular.toJson(results));
                                if (results.status === true) {
                                    noty({
    ...
    $scope.editClientRequest = function (clientReqHeaderID, clientID) {
        ...
        $scope.cusObj.DeductionDetails = [];
        $scope.showLoader = true;
        ManageAvivaTransactionService.getClientRequestByID(clientReqHeaderID).then(function (results) {
            $scope.showLoader = false;
            if (results.status === true) {
                $scope.isViewMode = false;
                ...
                $scope.cusReqObj.ChildrenDetailss = angular.copy($scope.cusReqObj.FamilyDetails);
    ...
    $scope.calculateNetPremium = function (PaymentDetails) {
        ...
        for (var i = 0; i < $scope.ProRateObj.length; i++) {
            ...
            Age = $scope.ProRateObj[i].Age;
            join = $scope.ProRateObj[i].JoinDate;
           
            if ($scope.cusReqObj.PartnerID == 2) {
                if (Age <= 64) {
        ...
        for (var r = 0; r < PaymentDetails.length; r++) {
            ...
            PaymentDetails[r].PremiumAmount = PaymentDetails[r].PremiumAmount * $scope.ProRate + PaymentDetails[r].PremiumAmount;
            ...
            buttons: [
                    {
                        addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function ($noty) {
                            ...
                            if ($scope.cusObj.ChildrenDetailss != undefined ) {
                                ...
                                for (var i = 0; i < $scope.cusObj.ChildrenDetailss.length; i++) {
                                    ...
                                    if (/^\d{2}\/\d{2}\/\d{4}$/.test($scope.cusObj.ChildrenDetailss[i].MemberDOB)) {
                                        ...
                                        $scope.cusObj.ChildrenDetailss[i].MemberDOB = $scope.getFormattedDate($scope.cusObj.ChildrenDetailss[i].JoinDate);
                            ...
                            ManageAvivaTransactionService.updateClientRequest($scope.isCustomerUpdated, $scope.isCustomerAdded, $scope.cusObj, $scope.cusReqObj, $scope.currentUser.UserID).then(function (results) {
                                $scope.showLoader = false;
                                //alert(angular.toJson(results));
                                if (results.status === true) {
                                    noty({
    ...
    $scope.initializeQuotation = function (clientReqHeaderID) {
        ...
        $scope.showLoader = true;
        ManageAvivaTransactionService.initializeQuotation($scope.quotationHeader, $scope.currentUser.UserID).then(function (results) {
            $scope.showLoader = false;
            if (results.status === true) {
                $scope.quotationHeader = {};
                noty({
