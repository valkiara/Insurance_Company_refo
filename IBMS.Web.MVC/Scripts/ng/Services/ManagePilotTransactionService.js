...
ibmsApp.factory('ManagePilotTransactionService', function ($http, $rootScope) {
    ...
    var getClientByID = function (clientID) {
        ...
        return $http.post($rootScope.serviceURL + 'api/ClientRequest/GetPilotClientByClientID', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            //Handle error here
        });
    ...
    var saveClientRequest = function (isClientUpdated, isClientAdded, clientObj, clientRequestHeaderObj, userID) {
        ...
        return $http.post($rootScope.serviceURL + 'api/ClientRequest/SaveCustomerRequest', params, config).then(function (results) {
            return results.data;
        }, function (data) {
    ...
    var getClientRequestByID = function (clientReqHeaderID) {
        ...
        return $http.post($rootScope.serviceURL + 'api/ClientRequest/GetPilotRequestByID', params, config).then(function (results) {
            return results.data;
        }, function (data) {
    ...
    var updateClientRequest = function (isClientUpdated, isClientAdded, clientObj, clientRequestHeaderObj, userID) {
        var params = $.param({ "IsClientUpdated": isClientUpdated, "IsClientAdded": isClientAdded, "ClientObj": clientObj, "ClientRequestHeaderObj": clientRequestHeaderObj, "UserID": userID });
        return $http.post($rootScope.serviceURL + 'api/ClientRequest/UpdatePilotRequest', params, config).then(function (results) {
            return results.data;
        }, function (data) {
    ...
    var loadPPreimum = function () {
        return $http.post($rootScope.serviceURL + 'api/Utility/GetPilotPremium', null, config).then(function (results) {
            return results.data;
        }, function (data) {
            //Handle error here
        });
    ...
    var loadDeductionType = function (businessUnitID) {
        var params = $.param({ "businessUnitID": businessUnitID });
        return $http.post($rootScope.serviceURL + 'api/Utility/GetAllDeductionType', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            //Handle error here
        });
    ...
    var getAllPartners = function (businessUnitID) {
        var params = $.param({ "businessUnitID": businessUnitID });

        return $http.post($rootScope.serviceURL + 'api/Quotation/GetPremiumByBUID', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            //Handle error here
        });
    ...
    var loadPilotPremium = function () {
        
        return $http.post($rootScope.serviceURL + 'api/Utility/GetAllPilotPremium', null, config).then(function (results) {
            return results.data;
        }, function (data) {
            //Handle error here
        });
    ...
    return {
        loadPilotPremium:loadPilotPremium,
        loadDeductionType:loadDeductionType,
        loadTitle: loadTitle,
        loadPPreimum:loadPPreimum,
