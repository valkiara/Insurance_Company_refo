...
ibmsApp.factory('AvivaClaimRecordingService', function ($http, $rootScope) {
    ...
    var editClaimRecording = function (ReferenceNo) {
        var params = { "ClaimRecordingID": ReferenceNo, }
    ...
    var saveClaimRecording = function (Admission, userID) {
        var params = { "admission": Admission, "UserID": userID };
