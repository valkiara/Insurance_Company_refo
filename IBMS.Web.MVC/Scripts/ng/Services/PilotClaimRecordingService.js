...
ibmsApp.factory('PilotClaimRecordingService', function ($http, $rootScope) {
    ...
    var getAllPilotClaimRecording = function (BusinessUnitID) {
        var params = { "BusinessUnitID": BusinessUnitID, }
        return $http.post($rootScope.serviceURL + 'api/Admission/GetAllPilotAdmissions', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    var editClaimRecording = function (ClaimRecordingID) {
        ...
        return $http.post($rootScope.serviceURL + 'api/Admission/GetPIlotAdmissionByReferenceNo', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    var saveClaimRecording = function (policyInfoRecList, userID) {
        ...
        return $http.post($rootScope.serviceURL + 'api/Admission/SavePilotClameRecording', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    return {
        ...
        getAllPilotClaimRecording: getAllPilotClaimRecording
