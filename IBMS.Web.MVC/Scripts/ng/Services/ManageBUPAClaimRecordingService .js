...
ibmsApp.factory('ManageBUPAClaimRecordingService', function ($http, $rootScope) {
    ...
    var getAllClaimRecording = function (BusinessUnitID) {
        var params = { "BusinessUnitID": BusinessUnitID, }
        return $http.post($rootScope.serviceURL + 'api/Admission/GetAllAdmissions', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    var getMemeshipID= function (BusinessUnitID) {
        var params = { "BusinessUnitID": BusinessUnitID, }
        return $http.post($rootScope.serviceURL + 'api/Admission/GetClientBybusinessUnitID', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    var getClientByMemebership = function (MembershipID) {

        var params = { "MembershipID": MembershipID, }
        return $http.post($rootScope.serviceURL + 'api/Admission/GetClientByMemebershipID', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        });
    ...
    var editClaimRecording = function (patientAdmissionId) {
        var params = { "refNo": patientAdmissionId };
        return $http.post($rootScope.serviceURL + 'api/Admission/GetLocalAdmissionByReferenceNo', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    var saveClaimRecording = function (Admission) {
        var params = { "admission": Admission, "UserID": 1 };
        return $http.post($rootScope.serviceURL + 'api/Admission/SaveLocalAdmission', params, config).then(function (results) {
            return results.data;
        }, function (data) {
            // Handle error here
        })
    ...
    return {
        ...
        getMemeshipID: getMemeshipID,
        getClientByMemebership: getClientByMemebership,
